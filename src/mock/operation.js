...
//查询
Mock.mock(/\/api\/operation\/select/, 'get', function (options) {
...
//新增
Mock.mock('/api/operation/add', 'post', function (options) {
...
//修改
Mock.mock('/api/operation/update', 'post', function (options) {
    let info = JSON.parse(options.body)
...
//删除
Mock.mock(/\/api\/operation\/delete/, 'get', function (options) {
